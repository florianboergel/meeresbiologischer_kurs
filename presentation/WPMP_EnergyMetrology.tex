...
\title[Meeresbiologischer Kurs - Helgoland]{Meeresbiologischer Kurs - Helgoland}
\author[Florian]{}
\date{\today}
\semester{2016}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../../figures/helgoland_open_seamap_fino1.png}
\label{fig:fino1}
\end{figure} 
\end{frame}
\begin{frame}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{../../figures/fino_2_enhance.png}
\label{fig:fino2}
\end{figure} 
\end{frame}
\begin{frame}
